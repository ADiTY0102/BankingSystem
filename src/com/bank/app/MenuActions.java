...
public class MenuActions {
    ...
    public static void creditAccount(Scanner scanner,
        ...
        System.out.println("Credited at: "+DateUtil.now().toLocalDate()+"With status: " + (tx.isSuccess() ? "SUCCESS" : "FAILED"));
    }
    ...
    public static void debitAccount(Scanner scanner,
        ...
        Transaction tx = transactionService.processTransaction(req, account);
        System.out.println("Debited at: "+ DateUtil.now().toLocalDate()+"With Status: " + (tx.isSuccess() ? "SUCCESS" : "FAILED"));
    }
